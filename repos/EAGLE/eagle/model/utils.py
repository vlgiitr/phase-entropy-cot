...
def initialize_tree(input_ids, model, past_key_values, logits_processor):
    ...
    draft_tokens, retrieve_indices,tree_mask,tree_position_ids, draft_stats = model.ea_layer.topK_genrate(
        hidden_states,
        input_ids,
    ...
    return draft_tokens, retrieve_indices,tree_mask,tree_position_ids, orig, hidden_states, token, draft_stats
...
def update_inference_inputs(
    ...
    return input_ids, draft_tokens, retrieve_indices,tree_mask,tree_position_ids, new_token, None, token, draft_stats
